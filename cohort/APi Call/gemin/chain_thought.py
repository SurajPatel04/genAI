...
response = client.models.generate_content(
    ...
    contents=f"""role: system, content: {system_prompt}, 
    role: User, content: What is the 3*6, 

    role: asistant, content: {json.dumps({ "step": "analyse", "content": "The user is asking to calculate the product of two numbers, 3 and 6. This is a basic multiplication operation." })},

    role:  asistant, content: {json.dumps({ "step": "think", "content": "To find the product, I need to multiply the two given numbers, 3 and 6." })},

    role: asistant, content: {json.dumps({ "step": "think", "content": "I will multiply 3 and 6 to obtain the final result." })},
    """,
